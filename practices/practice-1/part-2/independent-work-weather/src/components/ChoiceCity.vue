...
<template>
  <div
    ...
    class="flex gap-x-3"
  >
    <span class="py-2 dark:text-gray-100">Choice city:</span>
    <div class="w-72 relative">
      <input
        class="border rounded border-gray-400 py-2 px-4 w-full bg-white dark:border-gray-500 dark:bg-gray-600 dark:text-white"
        type="text"
